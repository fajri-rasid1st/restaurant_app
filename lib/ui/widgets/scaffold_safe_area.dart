...
class ScaffoldSafeArea extends StatelessWidget {
  ...
  /// Whether to avoid system intrusions on the left side.
  final bool safeAreaLeft;

  /// Whether to avoid system intrusions on the top side.
  final bool safeAreaTop;

  /// Whether to avoid system intrusions on the right side.
  final bool safeAreaRight;

  /// Whether to avoid system intrusions on the bottom side.
